...
export function GalleryPage() {
  ...
  const [foldersRefreshToken, setFoldersRefreshToken] = useState(0);
  const [refreshFolderDatesToken, setRefreshFolderDatesToken] = useState(0);
      ...
      <main className="mx-auto max-w-6xl px-8 py-4 sm:px-10">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 [grid-template-areas:'content''media''actions'] lg:grid-cols-[minmax(0,1fr)_14rem] lg:gap-x-8 lg:[grid-template-areas:'content_actions''media_actions']">
          ...
          <FoldersList
            ...
            refreshToken={foldersRefreshToken}
            refreshFolderDatesToken={refreshFolderDatesToken}
            onRefreshFolderDatesStateChange={setIsRefreshingFolderDates}
